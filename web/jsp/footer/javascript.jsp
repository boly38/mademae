...
<script type="text/javascript" src="/js/${jquery_version}.js"></script>
<script type="text/javascript" src="/js/jquery.tmpl.min.js"></script>
<script type="text/javascript" src="/${bootstrap_version}/js/bootstrap.js"></script>
<script type="text/javascript" src="/${bootstrap_version}/js/bootstrap-alert.js"></script>
