...
<script type="text/javascript" src="/js/jquery/${jquery.version}.js"></script>
<script type="text/javascript" src="/js/jquery/jquery.tmpl.min.js"></script>
<script type="text/javascript" src="/${bootstrap.version}/js/bootstrap.js"></script>
<script type="text/javascript" src="/${bootstrap.version}/js/bootstrap-alert.js"></script>
